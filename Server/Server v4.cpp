...
//
//	void read(void) {
//		char type[2] = { 0 }; request r; type[1] = '\0'; int _type;
...
//		}
//		_type = std::stoi(type);
//		if (_type == 1) requesthelper::registerHandler(__peer, r);
//		else if ( _type == 2) requesthelper::loginHandler(_type, r);
//		else if (_type == 3) requesthelper::messageHandler(_type, r);
//			
//
//
//			
