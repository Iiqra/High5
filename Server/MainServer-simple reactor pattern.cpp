...
//
///* 
// * void send(ACE_SOCK_Stream& peer, std::string& buffer) {
//     peer.send_n(buffer.c_str(), buffer.length());
// * }
// */
//
...
//
////
////typedef ACE_Acceptor<MChatApplication::ClientHandler, ACE_SOCK_ACCEPTOR> Listener;
////
////Listener listener{addr, ACE_Reactor::instance()};
////
////class ClientHandler:
...
////
////int svc() override {
////ACE_DEBUG((LM_DEBUG, "(%t) Svc thread Started\n"));
////Here I am handling a client.
////return 0;
////}
////int handle_output(ACE_HANDLE fd) override { return 0; }
////int open(void* acceptor_or_connector) override {
////
