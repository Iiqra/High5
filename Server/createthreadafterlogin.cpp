...
//	std::string __response = "", sender, container, recipient;
//	std::string buffer = "";
//	std::string username, password, members, groupname, content, type;
//	bool isPrivate;
...
//			requesthelper::request_reader(__peer, sender, 6);
//			//sender = container; //u00001
